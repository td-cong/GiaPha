...
OrgChart._defaultConfig = function (t) {
          ...
          if (!a.notifierUI.show(t.notif)) {
            ...
            for (var d = 0; d < t.visibleNodeIds.length; d++) {
              var c = t.nodes[t.visibleNodeIds[d]]
                , g = a._get(c.id);
              OrgChart.RENDER_LINKS_BEFORE_NODES && (o += a.ui.link(c, a, l, t.bordersByRootIdAndLevel, t.nodes, e)),
                o += a.ui.node(c, g, t.animations, a.config, void 0, void 0, void 0, e, l, a)
            }
            ...
            if (OrgChart.events.publish("render", [a, n]),
              ...
              )) : !s || !a.response || s[0] == a.response.viewBox[0] && s[1] == a.response.viewBox[1] && s[2] == a.response.viewBox[2] && s[3] == a.response.viewBox[3] || e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update && e !== OrgChart.action.init ? 0 == m[0].length && (f || (i && i(),
                OrgChart.events.publish("redraw", [a]),
                f = !0)) : OrgChart.animate(a.getSvg(), {
                  viewbox: s
                }, {
                  viewbox: a.response.viewBox
  ...
  OrgChart.localStorage.getItem = function (t) {
    ...
    if (e) {
      ...
      (e = new Date).setDate(e.getDate() + 50 * 365),
        e = e.toISOString(),
  ...
  OrgChart.RES = {},
  OrgChart.RES.IT_IS_LONELY_HERE_LINK = "Chưa có gì cả, hãy thêm dữ liệu",
  OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE = 3,
  OrgChart.STRING_TAGS = !1,
  OrgChart.MAX_NODES_MESS = "Hết hạn sử dụng",
  OrgChart.OFFLINE_MESS = "Bản dùng thử bắt buộc phải kết nối internet",
  OrgChart.SEARCH_PLACEHOLDER = "Tìm kiếm... nhập ? để xem trợ giúp.",
  ...
  OrgChart.editUI.prototype.content = function (t, e, r, i, a) {
    ...
    if (L.setAttribute("data-boc-edit-form", ""),
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
      ...
      if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
        ...
        for (var y in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t),
          ...
          if (L.setAttribute("pointer-events", "none"),
            L) {
            var A = parseInt(L.getAttribute("width"))
              , N = parseInt(L.getAttribute("height"));
            L.setAttribute("x", -A / 2),
              L.setAttribute("y", -N / 2)
          }
          var E = m * Math.PI / (C / 2);
          m++;
          var M = Math.cos(E) * b
    ...
    for (var s = this.getSvg(), h = OrgChart._getClientXY(e), d = [], c = [], g = [], p = [], u = [], f = [], m = [], C = [], b = 0; b < o.length; b++) {
      ...
      if (x) {
        ...
        f.push(null),
          m.push(null),
          C.push(null);
      if (this.config.draggable == OrgChart.draggable.node)
        break
    }
    t._dragEventFired = !1;
    var w = null
      ...
      , A = function (e) {
        if (S) {
          ...
          if (h.left || h.right || h.up || h.down) {
            s.classList && (s.classList.remove("boc-cursor-grab"),
            ...
            i.moveStart(h, (function (t) {
              for (var e = 0; e < c.length; e++) {
                ...
                if (d[e].parent)
                  for (s = OrgChart.ui.link(d[e].parent, i, I, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0),
                    h = 0; h < s.length; h++) {
                    var p;
                    g = s[h];
                    (p = i.element.querySelector(`[data-l-id="[${g.id}][${g.childId}]"]`)) && (p.innerHTML = g.html)
                  }
                u[e].setAttribute("transform", "matrix(" + c[e].toString() + ")"),
                  f[e] && f[e].setAttribute("transform", "matrix(" + m[e].toString() + ")")
              }
            }
            ))
          } else {
            if (i.moveEnd(),
              s.classList && (s.classList.add("boc-cursor-grab"),
            ...
            if (null != w) {
              ...
              !i.canUpdateLink(d[0].id, w) && s.classList ? (s.classList.remove("boc-cursor-grab"),
                s.classList.remove("boc-cursor-move"),
                s.classList.remove("boc-cursor-copy"),
                s.classList.add("boc-cursor-nodrop")) : s.classList && (s.classList.remove("boc-cursor-grab"),
                  s.classList.remove("boc-cursor-move"),
            ...
            for (x = 0; x < c.length; x++) {
              ...
              if (d[x].parent)
                for (D = OrgChart.ui.link(d[x].parent, i, I, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0),
                  P = 0; P < D.length; P++) {
                  var j;
                  z = D[P];
                  (j = i.element.querySelector(`[data-l-id="[${z.id}][${z.childId}]"]`)) && (j.innerHTML = z.html)
            ...
            if (!t._dragEventFired && (Math.abs(r.x - S.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - S.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
              if (!1 === OrgChart.events.publish("drag", [i, a, e, o]) && N(),
                i.config.enableDragDrop)
            ...
            for (x = 0; x < c.length; x++)
              u[x].setAttribute("transform", "matrix(" + c[x].toString() + ")"),
                f[x] && f[x].setAttribute("transform", "matrix(" + m[x].toString() + ")")
          }
        }
      }
      , N = function (e) {
        ...
        if (i.moveEnd(),
          ...
          d[0].id != w && null != w) {
          var n = i.getNode(w);
          if (!1 === (l = OrgChart.events.publish("drop", [i, d[0].id, n.id, u[0], e])))
            return L(w, k),
            ...
            if (i.config.draggable && !1 !== l) {
              for (a = 0; a < d.length; a++) {
                ...
                if (h = chart.get(d[a].id)) {
                  ...
                  null != h.movex ? h.movex += c[4] - d[a].x : h.movex = c[4] - d[a].x,
                    null != h.movey ? h.movey += c[5] - d[a].y : h.movey = c[5] - d[a].y,
                    chart.update(h)
                }
              }
  ...
  OrgChart.manager._createNodes = function (t) {
        ...
        if (c) {
          ...
          if (!u) {
            if (!OrgChart.isNEU(c.pid))
              (ft = (b = l[c.pid]).childrenIds.indexOf(c.id)) > -1 && b.childrenIds.splice(ft, 1);
            s.push(c)
          }
        }
      }
    ...
    for (d = 0; d < S.length; d++) {
      ...
      for (v = 0; v < C.children.length; v++) {
        (H = C.children[v]).isAssistant ? I.push(H.id) : -1 != H.tags.indexOf("right-partner") ? (H.isPartner = 1,
          H.children = [],
          L.push(H.id)) : -1 != H.tags.indexOf("left-partner") ? (H.isPartner = 2,
            H.children = [],
            A.push(H.id)) : -1 == H.tags.indexOf("partner") || E % 2 ? -1 != H.tags.indexOf("partner") && E % 2 ? (H.isPartner = 2,
              H.children = [],
              A.push(H.id),
              E++) : H.parentPartner ? (N[H.parentPartner.id] || (N[H.parentPartner.id] = []),
                N[H.parentPartner.id].push(H.id)) : I.push(H.id) : (H.isPartner = 1,
                  H.children = [],
                  L.push(H.id),
                  E++)
      }
      ...
      for (v = 0; v < L.length; v++) {
        ...
        for (var R = 0; R < H.childrenIds.length; R++)
          P.push(H.childrenIds[R])
      }
      var F = [];
      for (v = 0; v < A.length; v++) {
        N[(H = l[A[v]]).id] ? C.children.push(H) : C.children.splice(0, 0, H);
        for (R = 0; R < H.childrenIds.length; R++)
          F.push(H.childrenIds[R])
      }
      ...
      for (v = 0; v < P.length; v++) {
        (H = l[P[v]]).collapsed || (H.parentPartner = H.parent,
          H.parent = C,
          H.isChildOfPartner = !0,
          C.children.push(H))
      }
    ...
    for (d = 0; d < w.length; d++) {
      ...
      for (v = 0; v < C.subLevels; v++) {
        ...
        if (OrgChart.manager._initDinamicNode(z, C.lcn),
          b = C.parent)
          (ft = b.children.indexOf(C)) > -1 && (b.children.splice(ft, 1),
            b.children.splice(ft, 0, z)),
            z.children.push(C),
            z.parent = b,
            C.parent = z,
            l[z.id] = z
    ...
    for (var j in _) {
      ...
      for (v = b.children.length - 1; v >= 0; v--) {
        (H = b.children[v]).isAssistant ? (H.parent = null,
          b.children.splice(v, 1),
          q.splice(0, 0, H.id)) : H.isPartner || (H.parent && k[H.parent.id] && z && H.parent.id != z.id && (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, H.parent.id)),
    ...
    link: function (t, e, r, i, a, n, o) {
      ...
      if (t.hasPartners) {
        ...
        for (var C = 0; C < t.children.length; C++) {
          (O = t.children[C]).parentPartner ? (m.ppnodes[O.id] = O.parentPartner,
            m.ids.push(O.id),
            1 == O.parentPartner.isPartner ? (-1 == m.rightIds.indexOf(O.parentPartner.id) && m.rightIds.push(O.parentPartner.id),
              m.indexes[O.id] = m.rightIds.indexOf(O.parentPartner.id),
              m.firstRight || (m.firstRight = O)) : 2 == O.parentPartner.isPartner && (-1 == m.leftIds.indexOf(O.parentPartner.id) && m.leftIds.push(O.parentPartner.id),
                m.indexes[O.id] = m.leftIds.indexOf(O.parentPartner.id),
                m.lastLeft = O)) : O.isPartner || (m.lastLeft = O,
      ...
      for (C = 0; C < t.children.length; C++) {
        var b, O = t.children[C], v = i[u][O.sl], y = {
          xa: 0,
          ya: 0,
          xb: 0,
          yb: 0,
        ...
        if (S)
          b = S,
            x = x.replace("{rounded}", S).replace("{edge}", S).replace("{curve}", b);
          ...
          -1 != x.indexOf("{edge}") ? (b = "M" + y.xa + "," + y.ya + " " + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " L" + y.xd + "," + y.yd,
            x = x.replace("{edge}", b)) : -1 != x.indexOf("{curve}") ? (b = "M" + y.xa + "," + y.ya + " C" + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " " + y.xd + "," + y.yd,
              x = x.replace("{curve}", b)) : (b = x.replaceAll("{xa}", y.xa).replaceAll("{ya}", y.ya).replaceAll("{xb}", y.xb).replaceAll("{yb}", y.yb).replaceAll("{xc}", y.xc).replaceAll("{yc}", y.yc).replaceAll("{xd}", y.xd).replaceAll("{yd}", y.yd),
                x = b);
        ...
        for (var E in e.config.linkBinding) {
          ...
          if (T) {
            ...
            A.value = B,
              A.element = h[E],
              A.name = M,
              !1 !== OrgChart.events.publish("label", [e, A]) && (OrgChart.isNEU(A.value) || OrgChart.isNEU(A.element) || (N += A.element.replace("{val}", A.value)))
          }
        }
        "" != N && (N = OrgChart.linkFieldsOpenTag.replace("{x}", y.x).replace("{y}", y.y).replace("{rotate}", 0) + N + OrgChart.grCloseTag,
          d.push(N)),
      ...
      for (var d = 1; d < t.length; d++) {
        ...
        if (p && c && c.length > 2 && "L" == g[0] && p.length > 2 && "L" == p[0]) {
          ...
          r ? (u = a(C, c.origPoint || m, e),
            f = a(C, p.origPoint || b, e)) : (u = i(C, m, e),
              f = i(C, b, e)),
            n(g, u),
            g.origPoint = C,
            l.push(g);
    ...
    if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
      ...
      !function (t, i, a) {
        ...
        function o() {
          ...
          Math.ceil(e.bar.scrollLeft) == Math.ceil(e.pos) ? n = !1 : (e.bar.scrollLeft += t,
            l(o))
        }
    ...
    if ((this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
      ...
      !function (t, i, a) {
        ...
        function o() {
          ...
          Math.ceil(e.bar.scrollTop) == Math.ceil(e.pos) ? n = !1 : (e.bar.scrollTop += t,
            l(o))
        }
        t.addEventListener("wheel", (function (t) {
          if (t.ctrlKey)
  ...
  OrgChart.prototype._slinks = function (t, e) {
    ...
    function n(e, n, o) {
      ...
      if (e.sl == n.sl)
        ...
        for (; null == h;) {
          var b = !1
            ...
            , v = O.leftNeighbor
            , y = O.rightNeighbor;
          if (O.id == n.id ? h = O : OrgChart._intersects(O, f, g) && (f = OrgChart._addPoint(O, s, g, f, d),
            b = !0),
            O.id != n.id) {
            for (; v;) {
              if (v.id == n.id) {
      ...
      for (var N = 1; N < s.length; N++)
        s[N].unshift("L");
      if (pathStr = OrgChart.roundPathCorners(s, OrgChart.LINK_ROUNDED_CORNERS, !1),
        l.label) {
      ...
      o && (B = n.id,
        U = e.id),
        r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", B).replace("{to}", U) + p.link.replaceAll("{d}", pathStr) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + pathStr + '" />',
        r += OrgChart.grCloseTag
    }
      ...
      this.element.innerHTML = `<div>${c}</div>`,
        this.element.addEventListener("click", (function (t) {
          if (t.target.hasAttribute("data-filter-close") || t.target.hasAttribute("data-filter-field")) {
            for (var e = t.target.getAttribute("data-filter-field"), r = d.instance.element.querySelectorAll("[data-filter-menu]"), i = 0; i < r.length; i++)
              ...
              for (i = 0; i < p.length; i++)
                p[i].addEventListener("change", (function (t) {
                  ...
                  if (e) {
                    ...
                    } else if (null != d.filterBy[r][this.name] && (d.filterBy[r][this.name].checked = this.checked),
                      this.checked)
                      for (var o = d.instance.config.nodes, l = 0; l < o.length; l++)
                        if (o[l][r] == this.name)
                          for (var s = o[l]; s;)
                            if (OrgChart.isNEU(s.stpid))
                              s = OrgChart.isNEU(s.pid) ? null : d.instance._get(s.pid);
                            else if ((s = d.instance._get(s.stpid))[r]) {
                              var h = t.target.parentNode.parentNode.querySelector('[name="' + s[r] + '"]');
                              h ? (h.checked = this.checked,
                                d.filterBy[r][s[r]].checked = this.checked) : console.error('Cannot find element with selector: [name="' + s[r] + '"]')
                            }
                    d.instance.draw()
                  }
                }
            ...
            o.style.display = "block",
              ...
              OrgChart.events.publish("show-items", [d, {
                name: e
              }])
          }
        }
